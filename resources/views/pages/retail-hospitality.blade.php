...
@section('content')
    <div class="sofax-breadcrumb">
        <div class="container">
            <h1 class="post__title">Retail & Hospitality</h1>
            <nav class="breadcrumbs">
                <ul>
                    <li><a href="index.html"> Business</a></li>
                    /
                    <li aria-current="page"> Retail & Hospitality</li>
                </ul>
            </nav>
                        ...
                        <div class="col-lg-7">
                            <div class="sofax-default-content tac ml-50">
                                <div class="tg-heading-subheading animation-style3">
                                    <h2 class="mb-3">Unique solutions for retail & hospitality</h2>
                                    <p>The retail and hospitality industries have specialized needs and we’re happy to help you create junk removal solutions tailored for you. Whether you need a hand with furniture removal, renovation cleanup, store closures, or storage cleanups, you can count on our reliable, on-demand service. We’ll be there whenever you need us, even if you need after-hours or weekend service!</p>
                                </div>
                                <div class="extra-mt">
                                    <strong>
                                        We help retail and hospitality businesses with:
                                    </strong>
                                    ...
                                    <div class="sofax-iconbox-wrap2">
                                        ...
                                        <div class="sofax-iconbox-data2">
                                            <h4>Replacing or updating displays
                                    ...
                                    <div class="sofax-iconbox-wrap2">
                                        ...
                                        <div class="sofax-iconbox-data2">
                                            <h4>Removing fixtures or furniture
