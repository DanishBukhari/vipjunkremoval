@extends('layouts.app')
@section('title', "Retail & Hospitality")

@section('content')
    <div class="sofax-breadcrumb">
        <div class="container">
            <h1 class="post__title">Education & Healthcare</h1>
            <nav class="breadcrumbs">
                <ul>
                    <li><a href="index.html"> Business</a></li>
                    /
                    <li aria-current="page"> Education & Healthcare</li>
                </ul>
            </nav>
                        ...
                        <div class="col-lg-7">
                            <div class="sofax-default-content tac ml-50">
                                <div class="tg-heading-subheading animation-style3">
                                    <h2 class="mb-3">Unique solutions for education & healthcare

                                    </h2>
                                    <p>
                                        The education and healthcare industries have specialized needs and we’re happy to help you create junk removal solutions tailored for you. Whether you need a hand with furniture removal, storage cleanouts, or require help with specialized waste removal, you can count on our reliable, on-demand service. We’ll be there whenever you need us, even if you need after-hours or weekend service!
                                    </p>
                                </div>
                                <div class="extra-mt">
                                    <strong>
                                        We help education & healthcare businesses with:
                                    </strong>
                                    ...
                                    <div class="sofax-iconbox-wrap2">
                                        ...
                                        <div class="sofax-iconbox-data2">
                                            <h4>Destruction of sensitive documents
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="sofax-iconbox-wrap2">
                                        ...
                                        <div class="sofax-iconbox-data2">
                                            <h4>Biohazardous waste disposal
                                            </h4>
                                        </div>
                                    </div>
                                    ...
                                    <div class="sofax-iconbox-wrap2">
                                        ...
                                        <div class="sofax-iconbox-data2">
                                            <h4>Replacing furniture or electronics
                                            </h4>
                                        </div>
                                    </div>
                                    ...
                                    <div class="sofax-iconbox-wrap2">
                                        ...
                                        <div class="sofax-iconbox-data2">
                                            <h4>Pharmaceutical waste management
                                            </h4>
                                        </div>
                                    </div>
                                    ...
                                    </div>   <div class="sofax-iconbox-wrap2">
                                        <div class="sofax-iconbox-icon2">
                                            <img src="{{asset("assets/images/pages/pmc.png")}}" alt="">
                                        </div>
                                        <div class="sofax-iconbox-data2">
                                            <h4>Electronic waste management
                                            </h4>
                                        </div>
                                    </div>   <div class="sofax-iconbox-wrap2">
                                        <div class="sofax-iconbox-icon2">
