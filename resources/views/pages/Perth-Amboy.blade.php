@extends('layouts.app')
@section('title', "Junk Removal in Perth Amboy, NJ")

@section('content')
    <div class="sofax-breadcrumb">
        <div class="container">
            <h1 class="post__title">Junk Removal in Perth Amboy, NJ</h1>
            <nav class="breadcrumbs">
                <ul>
                    <li><a href="/">Home</a></li>
                    /
                    <li aria-current="page">Perth Amboy</li>
                </ul>
            </nav>
        </div>
    </div>
    ...
    <div style="flex: 1.5; min-width: 300px;">
        <h3>Looking for hassle-free junk removal in Perth Amboy, NJ?</h3>
        <p>Look no further than V.I.P.nk Removal! We serve Pouth Amboy and the surrounding communities, specializing in reliable, eco-friendly, same-day junk hauling services for homes and businesses. Let us make your junk disappear—quickly and effortlessly.</p>
    </div>
    <div style="flex: 1; min-width: 300px; text-align: right;">
        <img src="assets/images/new2.jpeg" alt="Junk Removal South Amboy" style="border-radius: 20px; width: 100%; max-width: 400px; height: auto;">
            ...
            <div class="sofax-career-details-content terms-condition mb-40">
                <h3>Responsible junk disposal and recycling in Perth Amboy, NJ</h3>
                <p>Our dedication to responsible disposal drives everything we do. We focus on giving new life to items in good condition through repurposing, and for anything that can’t be reused, we make sure it’s recycled at local facilities right here in Perth Amboy. This is our way of contributing to a cleaner, more sustainable community.</p>
            </div>

            <div class="sofax-career-details-content terms-condition mb-40">
                <h3>What we take</h3>
                <p>We're a full-service junk removal company, which means we'll take anything non-hazardous that two people can lift. If you don’t need it, we can remove it from your Perth Amboy home or business. Items we take include (but are not limited to):</p>
